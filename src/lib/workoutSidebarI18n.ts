...
const familyCategoryAliases: Array<{
  ...
  { category: "7-Tage-Kitecamp auf Fehmarn", family: "Board Sports" },
  ...
  { category: "Billard", family: "Games" },
  { category: "Body Workout", family: "Fitness" },
  { category: "Bouldering", family: "Klettern" },
  { category: "Bowling", family: "Games" },
  { category: "Calisthenics", family: "Fitness" },
  { category: "Chair Dancing & Workout", family: "Fitness" },
  { category: "Boxen", family: "Combat Sports" },
  { category: "Core & Rücken", family: "Fitness" },
  ...
  { category: "Jugger", family: "Weitere Sportarten" },
  ...
  { category: "Kitesurfen", family: "Board Sports" },
  ...
  { category: "MMA - Mix Martial Arts", family: "Combat Sports" },
  ...
  { category: "Schach", family: "Games" },
  {
    category: "Segeln für Jugendliche in den Sommerferien",
    family: "Jollensegeln",
  },
  { category: "Segelgruppe der FH Kiel", family: "Jollensegeln" },
  { category: "Sensual Poledance 1", family: "Dance" },
  { category: "Sensual Poledance 2", family: "Dance" },
  { category: "Semestergebühr", family: "Services" },
  { category: "Skat", family: "Games" },
  { category: "Sportbootführerschein See", family: "Services" },
  { category: "Steeldart", family: "Games" },
  { category: "Step Aerobic", family: "Fitness" },
  { category: "Step Aerobic Mix", family: "Fitness" },
  ...
  { category: "Wingsurfen", family: "Board Sports" },
  ...
  { category: "Yin Yoga", family: "Yoga" },
  { category: "Zumba", family: "Dance" },
  { category: "Zumba Montags", family: "Dance" },
  { category: "Zumba und mehr", family: "Dance" },
];
